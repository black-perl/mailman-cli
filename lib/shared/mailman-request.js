...
/**
 * MCRequest is the base API request object constructor
 *
 * @class MCRequest
 * @constructor
 * @param {Object} options A hash of options for the MCRequest instance
 * @param {String} options.endpoint The endpoint URI for the invoking MC instance
 * @param {String} [options.username] A username for authenticating API requests
 * @param {String} [options.password] A password for authenticating API requests
 */
function MCRequest( options ) {
	/**
 ...
 *
 * @param {Function|undefined} fn A MCRequest request callback
 ...
 */
MCRequest.prototype._checkMethodSupport = function( method ) {
 ...
 */
MCRequest.prototype._renderPath = function() {
...
/**
 * Parse the request's instance properties into a Mailman REST API request URI
 *
 * @private
 *
 * @method _renderURI
 ...
 */
MCRequest.prototype._renderURI = function() {
 ...
 */
MCRequest.prototype._auth = function( request, forceAuthentication ) {
 ...
 *
 * @example
 * If auth credentials were already specified when the MC instance was created, calling
 ...
 * @return {MCRequest} The MCRequest instance (for chaining)
 */
MCRequest.prototype.auth = function( username, password ) {
 ...
 */
MCRequest.prototype.get = function( callback ) {
 ...
 * @return {Promise} A promise to the results of the HTTP request
 */
MCRequest.prototype.post = function( data, callback ) {
 ...
 * @return {Promise} A promise to the results of the HTTP request
 */
MCRequest.prototype.put = function( data, callback ) {
 ...
 * @return {Promise} A promise to the results of the HTTP request
 */
MCRequest.prototype.delete = function( callback ) {
 ...
 */
MCRequest.prototype.head = function( callback ) {
 ...
 * @return {Promise} A promise to the results of the HTTP request
 */
MCRequest.prototype.then = function( successCallback, failureCallback ) {
	return this.get().then( successCallback, failureCallback );
};

module.exports = MCRequest;
